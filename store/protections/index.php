                ...
                <div class="row">
                    <nav aria-label="breadcrumb" role="navigation" class="mx-auto">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo STORE_PATH . 'index'; ?>">Loja</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Proteções</li>
                        </ol>
                    </nav>
                </div>
