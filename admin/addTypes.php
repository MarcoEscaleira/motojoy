...
<div class="container">
    <div class="card" style="width: 100%;">
        <div class="card-body">
                ...
                <div class="col-8">
                    <nav aria-label="breadcrumb" role="navigation">
                        <ol class="breadcrumb backbread">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo ADMIN_PATH . 'types'; ?>">Painel tipos</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Criar tipo</li>
                        </ol>
                    </nav>
                </div>
                <div class="col-4">
            ...
            <div class="row">
                <h1 class="display-4 mx-auto mb-5 text-center">Criar um tipo</h1>
            </div>
            <div class="row">
                <div class="col-3"></div>
                <div class="col-6">
                    
                    <form action="actions/types/addTypesData" method="post" id="addTypesForm" action="javascript:;" autocomplete="off">
                        ...
                        <input type="submit" class="btn btn-outline-success btn-block mt-5" id="addTypeBtn" name="addTypeBtn" value="Criar">
                    </form>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        submitHandler: function (form) {
            var formData = new FormData($('#addTypesForm')[0]);

            $.ajax({
                url: 'actions/types/addTypesData',
                type: 'post',
                dataType: 'json',
                data: formData,
                contentType: false,
                ...
                success:function(response) {
                    ...
                    if (response.success == true) {
                        ...
                        $("#addTypesForm input").prop("disabled", true);
                        $("#addTypesForm select").prop("disabled", true);
